 ...
 */
int pca9685Setup(const int pinBase, const char *devPath, const int i2cAddress, int pinOE, float freq)
{
	...
	// Check i2c address
	int fd = wiringPiI2CSetupInterface(devPath, i2cAddress);
	if (fd < 0)
		return fd;
